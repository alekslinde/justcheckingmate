...
const GB_SEASONS: ScamSeason[] = [
  ...
  },
  {
    ...
    advice: "Government support is applied automatically or through GOV.UK — never a link asking for your bank details. Check any bill by logging in to your supplier directly.",
