...
const AU_THREATS: ThreatEntry[] = [
  {
    ...
    lastSeen: "2026-08-09",
    summary:
      "Texts claiming to be from VicRoads, Service NSW, Revenue NSW, Transport NSW or QLD Transport about an unpaid fine or a licence about to be suspended. State agencies were a gap while the scams focused on federal ones, and the kits have moved to fill it.",
    lures: [
    ...
    advice:
      "No state agency texts you a payment link for a fine. Look the fine up in the Service NSW or VicRoads app, or ring the number on a letter you were already sent — never the one in the message.",
  ...
  },
  {
    ...
    lastSeen: "2026-08-09",
    summary:
      "The July 2026 superannuation changes have been picked up as cover: texts posing as your fund or the ATO saying a rule change affects your balance and you need to verify details to keep access.",
    lures: [
    ...
    advice:
      "Real super rule changes are applied for you and never need you to confirm anything by text. Ring your fund on the number from your annual statement.",
